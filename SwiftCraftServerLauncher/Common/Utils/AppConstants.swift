...
enum AppConstants {
    ...
    static let paperDownloadsUserAgent = "\(Bundle.main.appName)/\(Bundle.main.fullVersion) (https://github.com/suhang12332/Swift-Craft-Launcher)"
...
extension Bundle {
    ...
    var copyright: String {
        return infoDictionary?["NSHumanReadableCopyright"] as? String ?? "Licensed under the AGPL License."
    }

    var identifier: String {
        return infoDictionary?["CFBundleIdentifier"] as? String ?? "com.su.code.SwiftCraftServerLauncher"
    }
